...
export const sectionsSeed: Array<{ section: SectionSeed; items: ItemSeed[] }> = [
  {
    section: { slug: 'experience', labelEn: 'Experience', labelSv: 'Erfarenhet', displayType: 'entries', sortOrder: 10 },
    items: [
      {
  ...
  {
    section: { slug: 'skills-technical', labelEn: 'Technical Skills', labelSv: 'Tekniska färdigheter', displayType: 'chips', sortOrder: 20 },
    items: [
  ...
  {
    section: { slug: 'skills-leadership', labelEn: 'Leadership Skills', labelSv: 'Ledarskapsförmågor', displayType: 'chips', sortOrder: 30 },
    items: [
  ...
  {
    section: { slug: 'skills-programming', labelEn: 'Programming Languages', labelSv: 'Programmeringsspråk', displayType: 'chips', sortOrder: 40 },
    items: [
  ...
  {
    section: { slug: 'skills-languages', labelEn: 'Languages', labelSv: 'Språk', displayType: 'chips', sortOrder: 50 },
    items: [
  ...
  {
    section: { slug: 'education', labelEn: 'Education', labelSv: 'Utbildning', displayType: 'entries', sortOrder: 60 },
    items: [
      ...
      { titleEn: 'Certified Project Manager, ProjektTeknik Gunnar Selin AB', titleSv: 'Certifierad projektledare, ProjektTeknik Gunnar Selin AB', startDate: '2002-01-01', sortOrder: 30 },
      { titleEn: 'Ph.Lic., Dept. Computer and Systems Sciences, Stockholm University', titleSv: 'Fil.lic., Inst. för data- och systemvetenskap, Stockholms universitet', startDate: '2000-01-01', sortOrder: 40 },
      { titleEn: 'M.Sc., Dept. Computer and Systems Sciences, Stockholm University', titleSv: 'Civilingenjör, Inst. för data- och systemvetenskap, Stockholms universitet', startDate: '1998-01-01', sortOrder: 50 },
    ],
  },
  {
    section: { slug: 'projects', labelEn: 'Projects', labelSv: 'Projekt', displayType: 'entries', sortOrder: 70 },
    items: [
      {
  ...
  {
    section: { slug: 'patents', labelEn: 'Patents', labelSv: 'Patent', displayType: 'entries', sortOrder: 80 },
    items: [
      ...
      { titleEn: 'Policy controlled preload and consumption of software application', titleSv: 'Policy controlled preload and consumption of software application', subtitleEn: 'WO 2013070126 A1 · Application', subtitleSv: 'WO 2013070126 A1 · Application', startDate: '2013-05-16', sortOrder: 30 },
      { titleEn: 'System and method for device addressing', titleSv: 'System and method for device addressing', subtitleEn: 'US 20120278854 A1 · Application', subtitleSv: 'US 20120278854 A1 · Application', startDate: '2012-11-01', sortOrder: 40 },
      { titleEn: 'Context-Aware Mobile Search Based on User Activities', titleSv: 'Context-Aware Mobile Search Based on User Activities', subtitleEn: 'US 20120269116 A1 · Application', subtitleSv: 'US 20120269116 A1 · Application', startDate: '2012-10-25', sortOrder: 50 },
      { titleEn: 'Method and system for conducting a monetary transaction using a mobile communication device', titleSv: 'Method and system for conducting a monetary transaction using a mobile communication device', subtitleEn: 'US 20120226611 A1 · Application', subtitleSv: 'US 20120226611 A1 · Application', startDate: '2012-09-06', sortOrder: 60 },
      { titleEn: 'Method, apparatus and computer program product for publishing public content and private content associated with the public content', titleSv: 'Method, apparatus and computer program product for publishing public content and private content associated with the public content', subtitleEn: 'US 20120204272 A1 · Application', subtitleSv: 'US 20120204272 A1 · Application', startDate: '2012-08-09', sortOrder: 70 },
      { titleEn: 'Method and arrangement in a communication network', titleSv: 'Method and arrangement in a communication network', subtitleEn: 'US 20120096156 A1 · Application', subtitleSv: 'US 20120096156 A1 · Application', startDate: '2012-04-19', sortOrder: 80 },
      { titleEn: 'Deviating behaviour of a user terminal', titleSv: 'Deviating behaviour of a user terminal', subtitleEn: 'US 20120060219 A1 · Application', subtitleSv: 'US 20120060219 A1 · Application', startDate: '2012-03-08', sortOrder: 90 },
      { titleEn: 'Method and Apparatus for Service Selection and Indication', titleSv: 'Method and Apparatus for Service Selection and Indication', subtitleEn: 'US 20110208824 A1 · Application', subtitleSv: 'US 20110208824 A1 · Application', startDate: '2011-08-25', sortOrder: 100 },
      { titleEn: 'Lossy compression of data', titleSv: 'Lossy compression of data', subtitleEn: 'WO 2009095083 A1 · Application', subtitleSv: 'WO 2009095083 A1 · Application', startDate: '2009-08-06', sortOrder: 110 },
    ],
  },
];
